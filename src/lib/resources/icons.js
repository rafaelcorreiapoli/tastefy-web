...
export Timer from 'material-ui/svg-icons/image/timer'
export Phone from 'material-ui/svg-icons/communication/phone'
export Calendar from 'material-ui/svg-icons/action/date-range'
export Edit from 'material-ui/svg-icons/editor/mode-edit'
export FilterIcon from 'material-ui/svg-icons/content/filter-list'
...
export ChevronLeft from 'material-ui/svg-icons/navigation/chevron-left'
export ChevronRight from 'material-ui/svg-icons/navigation/chevron-right'
export Camera from 'material-ui/svg-icons/image/camera'
